...
func (x *AgentLoginRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *AgentLoginRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\x11AgentLoginRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"*\n" +
	"\x12AgentLoginResponse\x12\x14\n" +
	...
	"\rValidateToken\x12\".auth_service.ValidateTokenRequest\x1a#.auth_service.ValidateTokenResponse\"\x00\x12Q\n" +
	"\n" +
	"AgentLogin\x12\x1f.auth_service.AgentLoginRequest\x1a .auth_service.AgentLoginResponse\"\x00B!Z\x1fauth_service/proto/auth_serviceb\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*AgentLoginRequest)(nil),     // 1: auth_service.AgentLoginRequest
	(*AgentLoginResponse)(nil),    // 2: auth_service.AgentLoginResponse
	(*LoginResponse)(nil),         // 3: auth_service.LoginResponse
	(*RegisterRequest)(nil),       // 4: auth_service.RegisterRequest
	(*RegisterResponse)(nil),      // 5: auth_service.RegisterResponse
	(*ValidateTokenRequest)(nil),  // 6: auth_service.ValidateTokenRequest
	(*ValidateTokenResponse)(nil), // 7: auth_service.ValidateTokenResponse
}
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth_service.AuthService.Login:input_type -> auth_service.LoginRequest
	4, // 1: auth_service.AuthService.Register:input_type -> auth_service.RegisterRequest
	6, // 2: auth_service.AuthService.ValidateToken:input_type -> auth_service.ValidateTokenRequest
	1, // 3: auth_service.AuthService.AgentLogin:input_type -> auth_service.AgentLoginRequest
	3, // 4: auth_service.AuthService.Login:output_type -> auth_service.LoginResponse
	5, // 5: auth_service.AuthService.Register:output_type -> auth_service.RegisterResponse
	7, // 6: auth_service.AuthService.ValidateToken:output_type -> auth_service.ValidateTokenResponse
	2, // 7: auth_service.AuthService.AgentLogin:output_type -> auth_service.AgentLoginResponse
